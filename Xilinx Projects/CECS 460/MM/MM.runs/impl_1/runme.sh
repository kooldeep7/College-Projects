...
HD_PWD='C:/Users/KuldeepGohil/Desktop/Spring2021/CECS460/labs/VivadoProjects/midtermProject/midtermProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoMatrixMultiplication_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwoMatrixMultiplication_wrapper.tcl -notrace
