...
HD_PWD='C:/Users/KuldeepGohil/Desktop/Spring2021/CECS460/labs/VivadoProjects/midtermProject/midtermProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwoMatrixMultiplication_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwoMatrixMultiplication_wrapper.tcl
