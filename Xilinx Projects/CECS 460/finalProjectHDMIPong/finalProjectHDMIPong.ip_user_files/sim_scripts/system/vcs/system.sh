...
#
# Generated by Vivado on Thu Feb 04 21:44:09 -0800 2021
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"D:/xilinx/Vivado/2018.3/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"D:/xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_4 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"D:/xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/98af/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/70cf/hdl" +incdir+"$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" +incdir+"D:/xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../CECS461_Lab1.srcs/sources_1/bd/system/ipshared/70cf/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
